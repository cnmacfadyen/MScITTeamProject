...
public class GamePlay {
	...
	public int selectStartingPlayer() {
		int selectRandomPlayer = random.nextInt(5);
	...
	public void selectCategory() {
		...
		int selectedCat =0;
		//human player
		if(selectStartingPlayer() == 0) {
			selectedCat = indx;
		}
		//AI player 1
		else if(selectStartingPlayer() == 1) {
			selectedCat = selectRandomCategory;
		}
		//AI player 2
		else if(selectStartingPlayer() == 2) {
			selectedCat = selectRandomCategory;
		}
		//AI player 3
		else if(selectStartingPlayer() == 3) {
			selectedCat = selectRandomCategory;
		}
		//AI player 4
		else if(selectStartingPlayer() == 4) {
			selectedCat = selectRandomCategory;
		}
	}
